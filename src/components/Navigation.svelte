            ...
            <div class="grid grid-cols-3 h-24 mx-auto font-medium md:overflow-visible px-4">
                <div class="flex items-center h-full">
                    <a href="{ base }" class="flex gap-3 inline-block py-4 md:py-0">
                        ...
                        <div class="-mt-0.5 text-xl font-bold">{title}</div>
                    </a>
                </div>
                <div class="flex justify-center space-x-8 items-center h-full">
                    <a href="{base}">About Us</a>
                    <a href="{base}">Blogs</a>
                    <a href="{base}">Developers</a>
                    <a href="{base}">Repository</a>
                </div>
                <div class="flex justify-end gap-x-6 items-center h-full">
                    ...
                    <svg class="cursor-pointer site-mobile-nav-show w-6 h-6 text-gray-700" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" x-cloak="">
